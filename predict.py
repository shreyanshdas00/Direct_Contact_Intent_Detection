...
from utils.predict_process import Processor
...
if __name__ == "__main__":
    ...
    confidence, pred_intent = Processor.validate(model, os.path.join(args.save_dir, "model/model.pt"),dataset,args.batch_size) 
